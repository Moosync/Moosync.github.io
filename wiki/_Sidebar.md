...
- [Building Moosync from Source](/wiki/building-from-source)
  ...
  - [Setting up the project](/wiki/building-from-source#setting-up-the-project)
  - [Downloading dependencies](/wiki/building-from-source#downloading-dependencies)
  - [Setting up environment variables](/wiki/building-from-source#setting-up-environment-variables)
  - [Post installation](/wiki/building-from-source#post-installation)
  - [Running in development environment](/wiki/building-from-source#running-in-development-environment)
  - [Building a production build](/wiki/building-from-source#building-a-production-build)
