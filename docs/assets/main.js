(() => {
    ...
    var De = (t, e, r) => {
        ...
        Ae = t => De(Me(J(t != null ? Ce(Re(t)) : {}, "default", t && t.__esModule && "default" in t ? {
            get: () => t.default,
            enumerable: !0
        } : {
            value: t,
...
`, e)
            ...
            t.Vector.prototype.positionForIndex = function (e) {
                ...
                for (var r = 0, n = this.elements.length / 2, i = n - r, s = Math.floor(i / 2), o = this.elements[s * 2]; i > 1 && (o < e && (r = s), o > e && (n = s), o != e);) 
                    i = n - r,
                    s = r + Math.floor(i / 2),
                    o = this.elements[s * 2];
            ...
            t.stemmer = function () {
                var e = {
                    ...
                    z = function (u) {
                        ...
                        if (S = u.substr(0, 1), S == "y" && (u = S.toUpperCase() + u.substr(1)), d = E, x = p, d.test(u) ? u = u.replace(d, "$1$2") : x.test(u) && (u = u.replace(x, "$1$2")), d = m, x = T, d.test(u)) {
                            var L = d.exec(u);
                            d = f,
                            d.test(L[1]) && (d = w, u = u.replace(d, ""))
                        } else if (x.test(u)) {
                            var L = x.exec(u);
                            g = L[1],
                            x = y,
                            x.test(g) && (u = g, x = k, R = M, D = j, x.test(u) ? u = u + "e" : R.test(u) ? (d = w, u = u.replace(d, "")) : D.test(u) && (u = u + "e"))
                        }
                        if (d = V, d.test(u)) {
                            var L = d.exec(u);
                            g = L[1],
                        ...
                        for (var h = s[l], f = 0; f < c; f++) {
                            ...
                            if (v == h || h == "*") {
                                var b = n.node.edges[v],
                                    ...
                                    E = b.final && y.final,
                                    p = void 0;
                                v in n.output.edges ? (p = n.output.edges[v], p.final = p.final || E) : (p = new t.TokenSet, p.final = E, n.output.edges[v] = p),
            ...
            t.Index.prototype.query = function (e) {
                for (var r = new t.Query(this.fields), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), c = 0; c < this.fields.length; c++) 
                        ...
                        for (var T = 0; T < E.length; T++) 
                            for (var w = E[T], k = this.invertedIndex[w], M = k._index, p = 0; p < l.fields.length; p++) {
                                var m = l.fields[p],
                                    ...
                                    B = w + "/" + m,
                                    q = new t.Set(V);
                                if (l.presence == t.Query.presence.REQUIRED && (f = f.union(q), o[m] === void 0 && (o[m] = t.Set.complete)), l.presence == t.Query.presence.PROHIBITED) {
                                    a[m] === void 0 && (a[m] = t.Set.empty),
                                    a[m] = a[m].union(q);
                                    continue
                                }
                                if (i[m].upsert(M, l.boost, function (Qe, Ie) {
                                    return Qe + Ie
                                }), ! s[B]) {
            ...
            t.Index.prototype.toJSON = function () {
                var e = Object.keys(this.invertedIndex).sort().map(function (n) {
                        return [
                            n, this.invertedIndex[n]
                        ]
                    }, this),
                    r = Object.keys(this.fieldVectors).map(function (n) {
                        return [
                            n, this.fieldVectors[n].toJSON()
                        ]
                    }, this);
                return {
                    version: t.version,
            ...
            t.Builder.prototype.calculateAverageFieldLengths = function () {
                for (var e = Object.keys(this.fieldLengths), r = e.length, n =
                    {}, i =
                    {}, s = 0; s < r; s++) {
            ...
            t.Builder.prototype.createFieldVectors = function () {
                for (var e =
                    {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                    for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName, c = this.fieldLengths[o], l = new t.Vector, h = this.fieldTermFrequencies[o], f = Object.keys(h), v = f.length, b = this._fields[a].boost || 1, y = this._documents[o.docRef].boost || 1, E = 0; E < v; E++) {
                        var p = f[E],
                            m = h[p],
            ...
            t.QueryParser.parsePresence = function (e) {
                ...
                if (r != null) {
                    switch (r.str) {
                        case "-": e.currentClause.presence = t.Query.presence.PROHIBITED;
                            break;
    ...
    var ee = class extends Z {
            constructor() {
                ...
                window.addEventListener("scroll", K(() => this.onScroll(), 10)),
                window.addEventListener("resize", K(() => this.onResize(), 10)),
                this.onResize(),
                this.onScroll()
            }
            triggerResize() {
            ...
            hideShowToolbar() {
                ...
                e !== this.showToolbar && (this.toolbar.classList.toggle("tsd-page-toolbar--hide"), this.secondaryNav.classList.toggle("tsd-navigation--toolbar-hide")),
    ...
    var te = class extends Q {
        ...
        createAnchors() {
            ...
            this.el.querySelectorAll("a").forEach(r => {
                let n = r.href;
                if (n.indexOf("#") == -1 || n.substr(0, e.length) != e) 
                    return;
        ...
        onResize() {
            ...
            let r = new CustomEvent("scroll", {
                detail: {
                    scrollTop: I.instance.scrollTop
                }
            });
            this.onScroll(r)
        }
        onScroll(e) {
            let r = e.detail.scrollTop + 5,
                ...
                i = n.length - 1,
                s = this.index;
            for (; s > -1 && n[s].position > r;) 
                s -= 1;
            
            for (; s < i && n[s + 1].position < r;) 
                s += 1;
    ...
    function He(t, e) {
        t.index || window.searchData && (e.classList.remove("loading"), e.classList.add("ready"), t.data = window.searchData, t.index = pe.Index.load(window.searchData.index))
    }
    function ze(t, e, r, n) {
        if (He(n, t), ! n.index || ! n.data) 
            return;
        ...
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            let c = n.data.rows[Number(s[o].ref)],
                l = ve(c.name, i);
            c.parent && (l =
                `<span class="parent">${ ve(c.parent, i)
            }.</span>${l}`);
    ...
    function ve(t, e) {
        ...
        let r = t.toLocaleLowerCase(),
            ...
            o = r.indexOf(n);
        for (; o != -1;) 
            i.push(re(t.substring(s, o)), `<b>${
                re(t.substring(o, o + n.length))
            }</b>`),
            s = o + n.length,
            o = r.indexOf(n, s);
        
        return i.push(re(t.substring(s))),
        i.join("")
    }
    var je = {
        "&": "&amp;",
    ...
    var ge = class {
        ...
        ne = class extends Q {
            constructor(e) {
                ...
                this.index = -1;
                this.createGroups(),
                this.container && (this.el.classList.add("active"), Array.from(this.el.children).forEach(r => {
            ...
            createGroups() {
                ...
                for (let n = 0; n < e.length; n++) 
                    this.groups.push(new ge(e[n], r[n]))
    ...
    function be(t) {
        ...
        t.addEventListener("change", () => {
            localStorage.setItem("tsd-theme", t.value),
            we(t.value)
        })
    }
    function we(t) {
